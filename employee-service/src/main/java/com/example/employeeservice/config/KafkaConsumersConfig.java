...
public class KafkaConsumersConfig {
	...
	// OrganizationEvent consumer configuaration
	  ...
	  public ConsumerFactory<String, OrganizationEvent> ConsumerFactory() {
	    ...
	    JsonDeserializer<OrganizationEvent> deserializer = new JsonDeserializer<>(OrganizationEvent.class);
		  ...
		  Map<String, Object> props = new HashMap<>();
		    ...
		    props.put(ConsumerConfig.GROUP_ID_CONFIG, "org_group");
	  ...
	  public ConcurrentKafkaListenerContainerFactory<String, OrganizationEvent> ContainerFactory() {
	    ConcurrentKafkaListenerContainerFactory<String, OrganizationEvent> factory =
